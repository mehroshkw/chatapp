...
class _SignUpState extends State<SignUp> {
  ...
  Future<void> validate(String email, String password, String name) async {
    if (formKey.currentState!.validate()) {
      // authController.emailController.toString();
      authController.signUpWithEmailAndPassword(email, password, name);
      print("Success");
    }}
            ...
            children: [
              ...
              GestureDetector(
                onTap: (){
                  ...
                  // );
                  validate(authController.emailController.text, authController.passwordController.text, authController.nameController.text);
